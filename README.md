...
Run our cli and make `sleep 10` command 3 times. Now we have 3 `sleep_n_print`
...
[Link to aiohttp_example.py](https://github.com/valentinmk/asynccmd/blob/master/examples/aiohttp_example.py)
